...
### 데이터 모델링 이란?  
   개발을 진행하는데 있어 전략 수립과 분석 단계 과정 전체를 뜻한다.
   즉, 업무에 대한 이해와 구체적인 조사 및 파악, 그리고 앞으로 어떻게 가야 할 것인가에 대한 확정을 모두 포함하는 __`과정의 툴`__ (인간이 결정해야 할 대부분의 사항이 취급되고 확정되어 가는 모든 과정을 포함) 을 뜻한다.
